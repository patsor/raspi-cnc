...
\begin{figure}[ht!]
	...
	\draw[densely dotted] (1.5, -0.2) -- (1.5, 7.8);
	\draw[densely dotted] (5.5, -0.2) -- (5.5, 7.8);
	\draw[densely dotted] (9.5, -0.2) -- (9.5, 7.8);
	\draw[densely dotted] (13.5, -0.2) -- (13.5, 7.8);
	...
	\draw[densely dotted] (5.125, 6.8) -- (5.125, 6.5);
	\draw[densely dotted] (5.125, 6.1) -- (5.125, 1.8);
	\draw[densely dotted] (7.5, 6.8) -- (7.5, 5.5);
	\draw[densely dotted] (9.875, 6.8) -- (9.875, 6.5);
	\draw[densely dotted] (9.875, 6.1) -- (9.875, 1.8);
	...
	\draw[densely dotted] (-0.1, 1.625) -- (5, 1.625);
	\draw[densely dotted] (5.3, 1.625) -- (9.6, 1.625);
	\draw[densely dotted] (-0.1, 4) -- (7, 4);
	\draw[densely dotted] (-0.1, 6.375) -- (5, 6.375);
	\draw[densely dotted] (5.3, 6.375) -- (9.6, 6.375);
	
	\draw[densely dotted] (-0.1, 8) -- (1.3, 8);
	\draw[densely dotted] (1.7, 8) -- (5.3, 8);
	\draw[densely dotted] (5.7, 8) -- (9.3, 8);
	\draw[densely dotted] (9.7, 8) -- (13.3, 8);
...
\begin{figure}[ht!]
	...
	\draw[thick] (0, 0) -- (7, 0) -- (7, 3.4) -- (5, 5.4) -- (2, 5.4) -- (0, 3.4) -- (0, 0);
...
\begin{figure}[ht!]
	...
	% scale 1:1
	\draw[thick] (0, 0) -- (7, 0) -- (7, 3.4) -- (5, 5.4) -- (2, 5.4) -- (0, 3.4) -- (0, 0);
	\draw[thick] (2, 5.4) -- (3, 6.4) -- (6, 6.4) -- (5, 5.4);
	\draw[thick] (6, 6.4) -- (8, 4.4) -- (7, 3.4);
	\draw[thick] (8, 4.4) -- (8, 1) -- (7, 0);
	\draw[dotted] (0, 0) -- (1, 1) -- (8, 1);
	\draw[dotted] (1, 1) -- (1, 4.4);
	
	\draw[dotted] (1.4, 0.5) ellipse (3mm and 1.5mm);
	\draw[dotted] (1.4, 2.5) ellipse (3mm and 1.5mm);
	\draw[dotted] (1.1, 0.5) --(1.1, 2.5);
	\draw[dotted] (1.7, 2.5) -- (1.7, 0.5);
	\draw[dotted] (6.6, 0.5) ellipse (3mm and 1.5mm);
	\draw[dotted] (6.6, 2.5) ellipse (3mm and 1.5mm);
	\draw[dotted] (6.3, 0.5) -- (6.3, 2.5);
	\draw[dotted] (6.9, 2.5) -- (6.9, 0.5);
