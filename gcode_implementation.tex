...
Linear interpolation is required to make coordinated movements across axis. Therefore we have to synchronize axis movement in order to have all involved axes reach destination at the same time point.
\begin{figure}[h]
	\begin{tikzpicture}
	% draw coordinate system
	\draw[step=1cm,gray,very thin] (-0.9,-0.9) grid (9.9,6.9);
